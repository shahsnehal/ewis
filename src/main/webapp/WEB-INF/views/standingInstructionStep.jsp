...
<head>
	...
	<title>Standing Instruction Step</title>
</head>
<body style="margin: 0">
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-10">
				...
				<div class="panel-heading">Standing Instruction</div>
				
				<div class="panel-body">
				
				<form action="saveStandingVerificationStep" class="form-horizontal" method="post" id="saveStandingVerificationStep">
					...
					<div class="modal-footer">
			        	<button type="submit" class="btn btn-primary btn-sm" onclick="formSubmit('saveStandingVerificationStep')" data-dismiss="modal" id="saveBtn" >Save</button>
			      	</div>
		   		</form>
				<br>
				</div>
